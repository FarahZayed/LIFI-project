...
void DIO_DIR(Dio_PortType port_name, Dio_PinType pin_num, Dio_PinDirectionType direction)
{
    ...
    {
    case PORTA:
        LOCK_PTR = (Dio_PortType_ptr)&GPIO_PORTA_LOCK_R;
        CR_PTR = (Dio_PortType_ptr)&GPIO_PORTA_CR_R;
    ...
    case PORTB:
        LOCK_PTR = (Dio_PortType_ptr)&GPIO_PORTB_LOCK_R;
    ...
    case PORTE:
        LOCK_PTR = (Dio_PortType_ptr)&GPIO_PORTE_LOCK_R;
        CR_PTR = (Dio_PortType_ptr)&GPIO_PORTE_CR_R;
    ...
    *LOCK_PTR = 0x4C4F434B; // Unlock the PORT
    SET_BIT(*CR_PTR, pin_num);

    if (direction == OUTPUT)
    {
        SET_BIT(*DIR_PTR, pin_num); // Direction
    }
    else
    {
    ...
    SET_BIT(*DEN_PTR, pin_num); // Enable the pins
}
...
Dio_PinType DIO_ReadPin(Dio_PortType port_name,Dio_PinType pin_num){
 volatile Dio_PortType_ptr DATA_PTR = NULL_PTR;  
  switch(port_name) {
    case PORTA: DATA_PTR = (Dio_PortType_ptr)&GPIO_PORTA_DATA_R;  break;
    case PORTB: DATA_PTR = (Dio_PortType_ptr)&GPIO_PORTB_DATA_R;  break;
    case PORTC: DATA_PTR = (Dio_PortType_ptr)&GPIO_PORTC_DATA_R;  break;
    case PORTD: DATA_PTR = (Dio_PortType_ptr)&GPIO_PORTD_DATA_R;  break;
    case PORTE: DATA_PTR = (Dio_PortType_ptr)&GPIO_PORTE_DATA_R;  break;
    case PORTF: DATA_PTR = (Dio_PortType_ptr)&GPIO_PORTF_DATA_R;  break;
    default: break;  
  }
  return READ_BIT(*DATA_PTR,pin_num);

}

Dio_PinType DIO_ReadPort(Dio_PortType port_name){
 volatile Dio_PortType_ptr DATA_PTR = NULL_PTR;  
  switch(port_name) {
    case PORTA: DATA_PTR = (Dio_PortType_ptr)&GPIO_PORTA_DATA_R;  break;
    case PORTB: DATA_PTR = (Dio_PortType_ptr)&GPIO_PORTB_DATA_R;  break;
